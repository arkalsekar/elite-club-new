...
const products: ProductType[] = [
    {
        id: 1,
        link: ['Home', 'About', 'Team', 'Certificate'],
    },
    {
        id: 2,
        link: ['Help', 'Contact', 'Policy', 'Terms']
    }
]
            ...
            <div className="mx-auto max-w-2xl pt-48 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="my-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className='col-span-4 md:col-span-12 lg:col-span-4'>
                        ...
                        <Image src={'/assets/logo/white-logo.png'} alt="logo" className='pb-8' width={130} height={60} />
                    ...
                    <div className='col-span-4 md:col-span-4 lg:col-span-4'>
                        <div className="flex gap-2">
                            ...
                            <h5 className="text-base font-normal text-offwhite"> Plot No. 2 & 3, Sector - 16, Near Thana Naka, Khandagao, New Panvel</h5>
                        </div>
                        <div className="flex gap-2 mt-10">
                            <Image src={'/assets/footer/telephone.svg'} alt="telephone-icon" width={24} height={24} />
                            <h5 className="text-base font-normal text-offwhite">+91 99583 99157</h5>
                        </div>
                        <div className="flex gap-2 mt-10">
                            <Image src={'/assets/footer/email.svg'} alt="email-icon" width={24} height={24} />
                            <h5 className="text-base font-normal text-offwhite">mudassirs472@gmail.com</h5>
                        </div>
                    </div>
                ...
                <div className='py-10 lg:flex items-center justify-between border-t border-t-bordertop'>
                    <h4 className='text-offwhite text-sm text-center lg:text-start font-normal'>@2024 Club. All Rights Reserved by <Link href="https://awdeveloper.in" target="_blank"> Aw Dev</Link></h4>
