...
// import { Calendar, Users, Building, PartyPopper, Code, Laptop, Trophy, GraduationCap, Check } from 'lucide-react'
...
//                       {item.completed && (
//                         <span className="absolute -bottom-1 -right-1 bg-green-500 text-white rounded-full p-[2px] flex items-center justify-center">
...
//                       <div className="text-sm font-medium" style={{ color: '#3B82F6' }}>{item.date}
//                         {item.completed &&
